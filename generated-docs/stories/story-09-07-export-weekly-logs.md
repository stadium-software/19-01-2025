...
### Happy Path
- [x] Given I am on Weekly Process Logs page, when I click "Export to Excel", then I download an Excel file with two sheets
- [x] Given I open the export, when I review it, then I see: Sheet 1 (Process Logs), Sheet 2 (User Audit Trail)
- [x] Given I export, when I view the file, then I see batch date in the header
